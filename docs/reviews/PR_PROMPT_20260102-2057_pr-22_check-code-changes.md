...
- Prompt artifact: docs/reviews/PR_PROMPT_20260102-2057_pr-22_check-code-changes.md
...
- Create or provide the complete contents for:
  - docs/reviews/PR_REVIEW_20260102-2057_pr-22_check-code-changes.md
- Your response must end with the **Copy/paste PR reply** block suitable for GitHub.
- Optional: I may paste that reply into:
  - docs/reviews/PR_REPLY_20260102-2057_pr-22_check-code-changes.md
