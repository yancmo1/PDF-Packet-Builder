# PR Fix (Implementation) — PR #22 — check code changes
...
## Inputs
- PR number: 22
- Topic: check code changes
- Prompt artifact: docs/reviews/PR_FIX_PROMPT_20260102-2223_pr-22_check-code-changes.md
- Review artifact (most recent if present): docs/reviews/PR_REVIEW_20260102-2057_pr-22_check-code-changes.md
- Reply scratchpad (optional): docs/reviews/PR_REPLY_20251230-2231_pr-22_need-to-pull-and-review.md
...
## What to do
1) Read `docs/reviews/PR_REVIEW_20260102-2057_pr-22_check-code-changes.md` if it exists (or the review content I paste in chat) and extract:
